...
//: No. init takes optional String type; the instance variables have unwrapped String type.
...
//: This should be a class method because it's invoked by Words.arePalindromes.
...
//: countLetters is uninititalized so it will not be allowed to use in **Line Y**.
//: This function should be an instance method. In addition the last line should return true instead of nil.
